...
window.CursorPositionFunctions = {
    getCaretCoordinates: function (elName) {
        ...
        const a = span.offsetTop + parseInt(computed['borderTopWidth']);
        const b = span.offsetLeft + parseInt(computed['borderLeftWidth']);
        const c = a + "," + b;
    ...
    GetCharCursorPosition: function(el) {
